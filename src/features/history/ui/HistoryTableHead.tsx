export function HistoryTableHead() {
  return (
    <div className="grid grid-cols-[25px_25px_25px_50px_50px_1fr_30px_30px] sm:grid-cols-[60px_60px_60px_120px_120px_1fr_80px_120px] gap-4 px-3 sm:px-4 py-3 bg-muted/50 text-sm font-medium">
      ...
      <div className="text-center shrink-0 min-w-30 max-w-30 sm:max-w-max sm:min-w-30">
        코멘트
      </div>
